  ...
  constructor(sfHost, args) {
    ...
    if (requestTemplatesRawValue && requestTemplatesRawValue != "[]") {
      ...
      this.requestTemplates = [
        ...
        {requestType: "REST", httpMethod: "PUT", request: "Name,ShippingCity,NumberOfEmployees,AnnualRevenue,Website,Description\r\nLorem Ipsum,Milano,2676,912260031,https://ft.com/lacus/at.jsp,\"Lorem ipsum dolor sit amet\"", soapType: "Partner", bodyType: "csv", apiUrl: `/services/data/v${apiVersion}/jobs/ingest/[jobId]/batches/`, name: "Bulk insert job"},
        {requestType: "REST", httpMethod: "PATCH", request: "{\"state\" : \"UploadComplete\"}", soapType: "Partner", bodyType: "csv", apiUrl: `/services/data/v${apiVersion}/jobs/ingest/[jobId]`, name: "Bulk finished job"},
      ...
      h("div", {className: "area", id: "query-area"},
        h("div", {className: "query-controls"},
          ...
          h("div", {className: "query-history-controls"},
            h("select", {value: "", onChange: this.onSelectRequestTemplate, className: "request-history select-control", title: "Check documentation to customize templates"},
            ...
            h("div", {className: "button-group"},
              h("select", {value: "", onChange: this.onSelectHistoryEntry, className: "request-history select-control"},
            ...
            h("div", {className: "button-group"},
              h("select", {value: "", onChange: this.onSelectSavedEntry, className: "request-history select-control"},
              ...
              h("input", {placeholder: "Request Label", type: "save", className: "text-control save-control", value: model.requestName, onInput: this.onSetRequestName}),
        ...
        h("div", {className: "query-controls"},
          h("div", {className: "form-line"},
            ...
            h("span", {className: "form-value"},
              h("select", {name: "requestType", className: "select-control", onChange: this.setRequestType}, h("option", {value: "REST"}, "REST"), h("option", {value: "SOAP"}, "SOAP")))
          ),
          h("div", {hidden: model.requestType != "SOAP", className: "form-line"},
            h("label", {className: "form-input"},
              h("span", {className: "form-label"}, "WSDL")),
            h("span", {className: "form-value"},
              h("select", {name: "soapType", className: "select-control", onChange: this.setSoapType, value: model.soapType}, soapTypes.map(s => h("option", {value: s, key: s}, s))))),
          h("div", {hidden: model.requestType != "SOAP", className: "form-line"},
            h("label", {className: "form-input"},
              h("span", {className: "form-label"}, "Soap Method")),
            h("span", {className: "form-value"},
              h("select", {name: "soapMethod", className: "select-control", onChange: this.setSoapMethod}, model.soapMethods.map(s => h("option", {value: s, key: s}, s))))),
          h("div", {hidden: model.requestType != "REST", className: "form-line"},
            h("label", {className: "form-input"},
              h("span", {className: "form-label"}, "Method")),
            h("span", {className: "form-value"},
              h("select", {name: "httpMethod", className: "select-control", onChange: this.setHttpMethod, value: model.httpMethod}, httpMethods.map(s => h("option", {value: s, key: s}, s))))),
          h("div", {hidden: (model.requestType != "REST" || (model.httpMethod == "GET" || model.httpMethod == "DELETE")), className: "form-line"},
            ...
            h("span", {className: "form-value"},
              h("select", {name: "bodyType", className: "select-control", onChange: this.setBodyType, value: model.bodyType}, bodyTypes.map(s => h("option", {value: s, key: s}, s))))),
        ),
      ...
      h("div", {className: "area", id: "result-area"},
        h("div", {className: "result-bar"},
          ...
          model.apiResponse && h("div", {},
            h("select", {value: JSON.stringify(model.selectedTextView), onChange: this.onSelectTextView, className: "textview-format select-control"},
